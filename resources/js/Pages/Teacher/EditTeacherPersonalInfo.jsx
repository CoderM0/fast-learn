...
export default function EditTeacherPersonalInfo({ teacher }) {
    console.log(teacher);
    ...
    const edit_teacher = (e) => {
        e.preventDefault();
        post(route("teacher.profile.update_personal"));
    };
    return (
        <UserLayout>
            <CustomHead title={"Edit Personal Info"} />
            <form onSubmit={edit_teacher} className="m-2 p-2">
