...
export default function ViewTeacherProfile({ teacher_pro }) {
    const { user } = usePage().props.auth;
    return (
        <UserLayout>
            <CustomHead title={teacher_pro.full_name + " profile"} />
                ...
                >
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center">
                            <img
                                src={`/storage/${teacher_pro.user.avatar}`}
                                alt=""
                            />
                        </div>

                        <h1 className="text-3xl font-bold pt-8 lg:pt-0">
                            {teacher_pro.full_name}
                        </h1>
                        ...
                        <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                            ...
                            Expertise : {teacher_pro.expertise}
                        </p>
                        <p className="pt-2  text-base font-bold flex gap-3 items-center justify-center lg:justify-start">
                            <TbLicense
                                className="text-green-500"
                                size={"1.5rem"}
                            />
                            License : {teacher_pro.license}
                        </p>
                        <p className="pt-2  text-base font-bold flex gap-3 items-center justify-center lg:justify-start">
                            <MdEmail
                                className="text-green-500"
                                size={"1.5rem"}
                            />
                            Email : {teacher_pro.user.email}
                        </p>
                        <p className="pt-8 text-sm font-bold">
                            bio : {teacher_pro.biography}
                        </p>
                        {teacher_pro.user.id == user.id && (
