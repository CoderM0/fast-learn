...
export default function EditStudentPersonalInfo({ student }) {
    ...
    const add_student = (e) => {
        e.preventDefault();
        post(route("student.update_personal"), {
            onSuccess: () => reset(),
        });
    };
    return (
        <UserLayout>
            <CustomHead title={"edit " + student.full_name + " profile"} />
            <form
                onSubmit={add_student}
                className="bg-white p-2 w-11/12 mx-auto"
            >
