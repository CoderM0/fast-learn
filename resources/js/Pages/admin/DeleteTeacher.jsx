...
export default function DeleteTeacher({ teacher, className }) {
    ...
    const deleteUser = (e) => {
        ...
        destroy(route("admin.teacher.destroy", teacher.id), {
            preserveScroll: true,
                ...
                >
                    <form onSubmit={deleteUser} className="p-2">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Once teacher account is deleted, all of its
                            resources and courses will be permanently deleted.
                        </p>
